...
const Contracts = () => {
    ...
    return (
        <div className="animate-fade-in">
            ...
            {loading ? <div className="flex justify-center py-12"><LoadingSpinner size="md" /></div> : contracts.length === 0 ? <Card className="p-8 text-center"><FileText className="h-8 w-8 text-gray-600 mx-auto mb-3" /><p className="text-gray-500">No contracts found</p></Card> : (
